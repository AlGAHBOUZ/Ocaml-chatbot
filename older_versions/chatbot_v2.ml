...
let main() =
  ...
  printf "Al Gamel bema 7amel: %s" ask_user_name;
 ...
 let old_category = !category_arr.(Array.length !category_arr -1) in
  ...
  goodbye_delay();
  printf "- Al Gamel bema 7amel: It has been a pleasure helping you, I hope you enjoyed this experience... See you soon :)\n";
;;
